...
i = cv2.imread(r'C:\Users\sange\OneDrive\Desktop\Contour\Birds.jpg')
...
ret, thresh1 = cv2.threshold(gaussian_blur,192,255,cv2.THRESH_BINARY)
...
cnts = imutils.grab_contours(cnts)[4:5]
...
cv2.waitKey(0)
cv2.imwrite("Birds_cnts.jpg", contour)